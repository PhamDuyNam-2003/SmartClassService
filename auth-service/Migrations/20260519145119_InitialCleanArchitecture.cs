        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentStudentCount = table.Column<int>(type: "integer", nullable: false),
                    LearningType = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    IsAttendanceLocked = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassroomMemberId = table.Column<Guid>(type: "uuid", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_ClassroomMembers_ClassroomMemberId",
                        column: x => x.ClassroomMemberId,
                        principalTable: "ClassroomMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_ClassroomMemberId",
                table: "Attendances",
                column: "ClassroomMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_Attendances_SessionId_ClassroomMemberId",
                table: "Attendances",
                columns: new[] { "SessionId", "ClassroomMemberId" },
                unique: true);
